...
public class ChitietSanPhamController {
    ...
    public String save(@Valid @ModelAttribute("chiTietSPDTO") ChitietSanPham chiTietSanPham,
        ...
        Path path = Paths.get("C:\\Users\\HP probook\\Downloads\\WebQuanAo2\\WebQuanAo\\src\\main\\webapp\\img");
        try {
    ...
    public String update(@PathVariable(name = "id") Integer id,
        ...
        if (imageFile != null && !imageFile.isEmpty()) {
            String uploadDir = "C:\\Users\\HP probook\\Downloads\\WebQuanAo2\\WebQuanAo\\src\\main\\webapp\\img";
