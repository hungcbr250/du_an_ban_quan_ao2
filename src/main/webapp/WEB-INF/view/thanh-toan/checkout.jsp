          ...
          <div class="row">
            <div class="col-lg-8">
              <form  action="/thanh-toan/${hoaDon.id}" method="post">
                <div class="row gy-3">
                  <div class="col-lg-6">
                    <label class="form-label text-sm text-uppercase" for="phone">Tên người nhận</label>
                    <input class="form-control form-control-lg" type="text" id="address1" placeholder="House number and street name" name="tenNguoiNhan"></input>

                  </div>
                  <div class="col-lg-6">
                    <label class="form-label text-sm text-uppercase" for="address">SDT người nhận</label>
                    <input class="form-control form-control-lg" type="tel" id="phone1" placeholder="e.g. +02 245354745" name="sdtNguoiNhan"></input>

                  </div>
                </div>
                <div class="row gy-3">
                  <div class="col-lg-6">
                    <label class="form-label text-sm text-uppercase" for="phone">SDT người đặt</label>
                    <input class="form-control form-control-lg" type="tel" id="phone" placeholder="e.g. +02 245354745" name="sdt"></input>
                  </div>
                  <div class="col-lg-6">
                    <label class="form-label text-sm text-uppercase" for="address">Địa chỉ</label>
                    <input class="form-control form-control-lg" type="text" id="address" placeholder="House number and street name" name="diaChi"></input>
                  </div>
