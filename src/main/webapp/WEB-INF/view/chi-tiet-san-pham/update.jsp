            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="container">
                <form:form class="w3-container" action="/chi-tiet-san-pham/update/${chiTietSPDTO.id}" method="post" enctype="multipart/form-data" modelAttribute="chiTietSPDTO" onsubmit="return confirmAdd()">
                                ...
                                <div class="row">
                                    ...
                                    <form:input class="form-control" path="image" type="file" value="${chiTietSPDTO.image}"></form:input>
                                </div>
                                <br>
