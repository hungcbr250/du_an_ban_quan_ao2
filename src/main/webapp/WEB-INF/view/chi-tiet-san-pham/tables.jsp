...
<%--                        </form>--%>
                        <form method="POST" action="/chi-tiet-san-pham/upload" enctype="multipart/form-data" class="my-4"  onsubmit="return confirmAdd()">
                            <div class="input-group">
...
<%--                                        <a href="/chi-tiet-san-pham/detail/${ctsp.id}" class="btn btn-sm btn-primary">Detail</a>--%>
                                        ...
                                        <a href="/chi-tiet-san-pham/remove/${ctsp.id}" onclick="return confirmRemove()" class="btn btn-sm btn-danger">Tắt</a>
                                        <a href="/chi-tiet-san-pham/hoatdong/${ctsp.id}" onclick="return confirmRemove1()" class="btn btn-sm btn-danger">Bật</a>
                                    </td>
                                </tr>
                            </c:forEach>
